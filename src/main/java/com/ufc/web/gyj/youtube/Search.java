package com.ufc.web.gyj.youtube;
...
/**
 * Beaseado em: https://developers.google.com/youtube/v3/code_samples/java#search_by_keyword
 */
public class Search {
   ...
   */
  public static List<SearchResult> pesquisar(String query) {
    ...
    try {
      ...
      String queryTerm = query;//getInputQuery();
